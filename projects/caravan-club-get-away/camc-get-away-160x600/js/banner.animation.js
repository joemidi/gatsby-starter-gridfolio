...
Banner.prototype.setup = function () {
  this.background2b.set({ scale: 0.9 });
...
Banner.prototype.animate = function () {
  ...
  var bg2Tween = new TweenMax.to(this.background2b, 5, { scale: 1, ease: Power0.easeNone }).pause();
  ...
  this.timeline = new TimelineLite({ delay: 0.5 }).from(this.logoSymbol, 0.8, { autoAlpha: 0, y: '-=1', ease: Power3.easeInOut }, 'frame1').from(this.logoText, 0.8, { autoAlpha: 0, y: '+=10', ease: Power3.easeInOut }, 'frame1+=0.2').from(this.background1a, 0.8, { autoAlpha: 0, ease: Power3.easeInOut }, 'frame1+=0.2').from(this.background1b, 0.8, { autoAlpha: 0, ease: Power3.easeInOut, onStart: function onStart() {
      ...
      bg3Tween.play();
    } }, 'frame5+=0.4').to(this.copy4, 0.8, { autoAlpha: 0, ease: Power2.easeOut }, 'frame5+=4.5').addLabel('frame6', 'frame5+=4.5').to(this.block5, 0.8, { height: 300, ease: Power2.easeOut }, 'frame6').staggerFrom([this.logoSmall, this.copy5, this.cta, this.tagline], 1.2, { autoAlpha: 0, y: '+=5', ease: Power3.easeInOut }, 0.2, 'frame6');
};