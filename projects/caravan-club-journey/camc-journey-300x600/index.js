...
(lib.txt_region = function(mode,startPosition,loop) {
	...
	this.locationSubTitleText.lineWidth = 297;
	this.locationSubTitleText.parent = this;
	this.locationSubTitleText.setTransform(139.8,2);

	this.timeline.addTween(cjs.Tween.get(this.locationSubTitleText).wait(1));

}).prototype = getMCSymbolPrototype(lib.txt_region, new cjs.Rectangle(-10.4,0,300.6,16), null);
...
(lib.txt_location = function(mode,startPosition,loop) {
	...
	this.locationTitleText.lineWidth = 297;
	this.locationTitleText.parent = this;
	this.locationTitleText.setTransform(139.8,2);

	this.timeline.addTween(cjs.Tween.get(this.locationTitleText).wait(1));

}).prototype = getMCSymbolPrototype(lib.txt_location, new cjs.Rectangle(-10.4,0,300.6,51), null);
...
(lib.Text3 = function(mode,startPosition,loop) {
	...
	this.Text3.lineWidth = 200;
	this.Text3.parent = this;
	this.Text3.setTransform(10,250);

	this.timeline.addTween(cjs.Tween.get(this.Text3).wait(1));

}).prototype = getMCSymbolPrototype(lib.Text3, new cjs.Rectangle(8,248,204.1,163), null);
...
(lib.Text2 = function(mode,startPosition,loop) {
	...
	this.Text2.lineWidth = 203;
	this.Text2.parent = this;
	this.Text2.setTransform(2,203.6);

	this.timeline.addTween(cjs.Tween.get(this.Text2).wait(1));

}).prototype = getMCSymbolPrototype(lib.Text2, new cjs.Rectangle(0,201.6,207.4,145), null);
...
(lib.Textstart = function(mode,startPosition,loop) {
	...
	this.TextStart.lineWidth = 199;
	this.TextStart.parent = this;
	this.TextStart.setTransform(101.5,-69.2);

	this.timeline.addTween(cjs.Tween.get(this.TextStart).wait(1));

}).prototype = getMCSymbolPrototype(lib.Textstart, new cjs.Rectangle(0,-71.2,203,58), null);
...
(lib.Textend = function(mode,startPosition,loop) {
	...
	this.TextEnd.setTransform(148.9,266.2);

	this.timeline.addTween(cjs.Tween.get(this.TextEnd).wait(1));

}).prototype = getMCSymbolPrototype(lib.Textend, new cjs.Rectangle(3.7,264.2,290.5,70), null);
...
(lib.button_end = function(mode,startPosition,loop) {
	...
	this.cta_text.setTransform(53.5,338.8);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#E18C36").s().p("An2DIQggAAAAgqIAAk9QAAgHACgGQAEgbAaAAIPuAAQAfAAAAAqIAAE7QAAANgDAJQgHAUgWAAg");
	this.shape.setTransform(53.5,348);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.cta_text}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.button_end, new cjs.Rectangle(0,328,107,40), null);
...
(lib.Scene4_Bottom = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(455).to({_off:false},0).wait(1).to({regX:329.2,regY:329.3,x:127.2,y:423.7,alpha:0.333},0).wait(1).to({alpha:0.667},0).wait(1).to({alpha:1},0).wait(1).to({regX:328.9,regY:328.7,x:126.9,y:423.1},0).wait(26).to({regX:329.2,regY:329.3,x:127.2,y:423.7,alpha:0},0).wait(1));
...
(lib.Scene3_Bottom = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(306).to({_off:false},0).wait(1).to({regX:329.2,regY:329.3,x:391.5,y:206.9,alpha:0.333},0).wait(1).to({alpha:0.667},0).wait(1).to({alpha:1},0).wait(1).to({regX:328.9,regY:328.7,x:391.2,y:206.3},0).wait(139).to({regX:329.2,regY:329.3,x:391.5,y:206.9,alpha:0.5},0).wait(1).to({alpha:0},0).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(306).to({_off:false},0).wait(1).to({regX:329.2,regY:329.3,x:134.7,y:206.9,alpha:0.333},0).wait(1).to({alpha:0.667},0).wait(1).to({alpha:1},0).wait(1).to({regX:328.9,regY:328.7,x:135,y:206.3},0).wait(138).to({regX:329.2,regY:329.3,x:134.7,y:206.9,alpha:0},0).wait(4));
...
(lib.Scene4_Top = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(455).to({_off:false},0).wait(3).to({x:324.2,y:172.8},0).wait(1).to({x:274.9,y:141.1},0).wait(1).to({x:250.2,y:129.5},0).wait(1).to({x:231.5,y:122.2},0).wait(1).to({x:216.2,y:117.1},0).wait(1).to({x:203.3,y:113.5},0).wait(1).to({x:192.2,y:110.9},0).wait(1).to({x:182.6,y:108.9},0).wait(1).to({x:174.1,y:107.5},0).wait(1).to({x:166.7,y:106.4},0).wait(1).to({x:160.1,y:105.6},0).wait(1).to({x:154.3,y:105},0).wait(1).to({x:149.2,y:104.6},0).wait(1).to({x:144.7,y:104.3},0).wait(1).to({x:140.8,y:104.1},0).wait(1).to({x:137.4,y:104},0).wait(1).to({x:134.4,y:103.9},0).wait(1).to({x:131.8},0).wait(1).to({x:129.6},0).wait(1).to({x:127.8},0).wait(1).to({x:126.3},0).wait(1).to({x:125.1},0).wait(1).to({x:124.2},0).wait(1).to({x:123.6},0).wait(1).to({x:123.2},0).wait(1).to({x:123.1},0).wait(1).to({y:104},0).wait(4).to({alpha:0.8},0).wait(1).to({alpha:0.6},0).wait(1).to({alpha:0.4},0).wait(1).to({alpha:0.2},0).wait(1).to({alpha:0},0).wait(2).to({_off:true},1).wait(8));

	// Mask (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_455 = new cjs.Graphics().p("AOFNyIESv5IQQEXIkRP6g");
	var mask_graphics_456 = new cjs.Graphics().p("AKiNGIEixAIUsFgIkiRCg");
	var mask_graphics_457 = new cjs.Graphics().p("AHGMdIEzyGIY+GnIkzSGg");
	var mask_graphics_458 = new cjs.Graphics().p("ADzL2IFCzIIdFHoIlCTJg");
	var mask_graphics_459 = new cjs.Graphics().p("AAnLQIFR0HMAhEAIoIlRUIg");
	var mask_graphics_460 = new cjs.Graphics().p("AicKtIFd1FMAk5AJkIleVGg");
	var mask_graphics_461 = new cjs.Graphics().p("AlZKMIFr2BMAolAKeIlsWAg");
	var mask_graphics_462 = new cjs.Graphics().p("AoNJsIF325MAsGALTIl3W6g");
	var mask_graphics_463 = new cjs.Graphics().p("Aq7JPIGE3wMAvfAMGImDXwg");
	var mask_graphics_464 = new cjs.Graphics().p("AtgIzIGO4kMAyvAM2ImPYkg");
	var mask_graphics_465 = new cjs.Graphics().p("Av+IZIGZ5WMA10ANkImYZVg");
	var mask_graphics_466 = new cjs.Graphics().p("AyUIAIGi6FMA4xAOOImiaFg");
	var mask_graphics_467 = new cjs.Graphics().p("A0iHpIGr6yMA7jAO2Imrayg");
	var mask_graphics_468 = new cjs.Graphics().p("A2pHUIG07cMA+MAPbImzbcg");
	var mask_graphics_469 = new cjs.Graphics().p("A4oHAIG88EMBAsAP+Im8cEg");
	var mask_graphics_470 = new cjs.Graphics().p("A6fGtIHD8qMBDCAQfInDcqg");
	var mask_graphics_471 = new cjs.Graphics().p("A8PGcIHK9NMBFOAQ9InJdNg");
	var mask_graphics_472 = new cjs.Graphics().p("A93GMIHQ9uMBHRARZInQdug");
	var mask_graphics_473 = new cjs.Graphics().p("A/XGOIHW+NMBJKARyInWeNg");
	var mask_graphics_474 = new cjs.Graphics().p("EggwAGQIHb+oMBK6ASJInbeog");
	var mask_graphics_475 = new cjs.Graphics().p("EgiAAGSIHf/CMBMgASfIngfCg");
	...
	var mask_graphics_481 = new cjs.Graphics().p("EginAGTIHi/OMBNQASpInifOg");
	var mask_graphics_482 = new cjs.Graphics().p("EginAGTIHi/OMBNQASpInifOg");
	var mask_graphics_483 = new cjs.Graphics().p("EginAGTIHi/OMBNQASpInifOg");
	var mask_graphics_484 = new cjs.Graphics().p("EginAGTIHi/OMBNQASpInifOg");
	var mask_graphics_485 = new cjs.Graphics().p("EginAGTIHi/OMBNQASpInifOg");
	var mask_graphics_486 = new cjs.Graphics().p("EgjvAGUIHg/MMBNOASlInhfMg");
	...
	var mask_graphics_498 = new cjs.Graphics().p("EgjyAGTIHi/OMBNQASpInifOg");
	var mask_graphics_499 = new cjs.Graphics().p("EgjyAGTIHi/OMBNQASpInifOg");
	var mask_graphics_500 = new cjs.Graphics().p("EgjyAGTIHi/OMBNQASpInifOg");
	var mask_graphics_501 = new cjs.Graphics().p("EgjyAGTIHi/OMBNQASpInifOg");
	var mask_graphics_502 = new cjs.Graphics().p("EgjyAGTIHi/OMBNQASpInifOg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(455).to({graphics:mask_graphics_455,x:221.5,y:116.2}).wait(1).to({graphics:mask_graphics_456,x:228.8,y:119.2}).wait(1).to({graphics:mask_graphics_457,x:235.9,y:122}).wait(1).to({graphics:mask_graphics_458,x:242.6,y:124.7}).wait(1).to({graphics:mask_graphics_459,x:249.2,y:127.3}).wait(1).to({graphics:mask_graphics_460,x:255.4,y:129.8}).wait(1).to({graphics:mask_graphics_461,x:261.5,y:132.1}).wait(1).to({graphics:mask_graphics_462,x:267.2,y:134.4}).wait(1).to({graphics:mask_graphics_463,x:272.8,y:136.5}).wait(1).to({graphics:mask_graphics_464,x:278.1,y:138.5}).wait(1).to({graphics:mask_graphics_465,x:283.1,y:140.4}).wait(1).to({graphics:mask_graphics_466,x:287.9,y:142.2}).wait(1).to({graphics:mask_graphics_467,x:292.4,y:143.9}).wait(1).to({graphics:mask_graphics_468,x:296.7,y:145.5}).wait(1).to({graphics:mask_graphics_469,x:300.8,y:147}).wait(1).to({graphics:mask_graphics_470,x:304.6,y:148.4}).wait(1).to({graphics:mask_graphics_471,x:308.1,y:149.7}).wait(1).to({graphics:mask_graphics_472,x:311.4,y:150.9}).wait(1).to({graphics:mask_graphics_473,x:314.5,y:150.4}).wait(1).to({graphics:mask_graphics_474,x:317.3,y:149.8}).wait(1).to({graphics:mask_graphics_475,x:319.9,y:149.3}).wait(1).to({graphics:mask_graphics_476,x:321.1,y:149.1}).wait(1).to({graphics:mask_graphics_477,x:321.1,y:149.1}).wait(1).to({graphics:mask_graphics_478,x:321.1,y:149.1}).wait(1).to({graphics:mask_graphics_479,x:321.1,y:149.1}).wait(1).to({graphics:mask_graphics_480,x:321.1,y:149.1}).wait(1).to({graphics:mask_graphics_481,x:321.1,y:149.1}).wait(1).to({graphics:mask_graphics_482,x:321.1,y:149.1}).wait(1).to({graphics:mask_graphics_483,x:321.1,y:149.1}).wait(1).to({graphics:mask_graphics_484,x:321.1,y:149.1}).wait(1).to({graphics:mask_graphics_485,x:321.1,y:149.1}).wait(1).to({graphics:mask_graphics_486,x:313.5,y:149.4}).wait(1).to({graphics:mask_graphics_487,x:313.6,y:149.4}).wait(1).to({graphics:mask_graphics_488,x:313.6,y:149.4}).wait(1).to({graphics:mask_graphics_489,x:313.6,y:149.4}).wait(1).to({graphics:mask_graphics_490,x:313.6,y:149.4}).wait(1).to({graphics:mask_graphics_491,x:313.6,y:149.4}).wait(1).to({graphics:mask_graphics_492,x:313.6,y:149.4}).wait(1).to({graphics:mask_graphics_493,x:313.6,y:149.4}).wait(1).to({graphics:mask_graphics_494,x:313.6,y:149.4}).wait(1).to({graphics:mask_graphics_495,x:313.6,y:149.4}).wait(1).to({graphics:mask_graphics_496,x:313.6,y:149.4}).wait(1).to({graphics:mask_graphics_497,x:313.6,y:149.4}).wait(1).to({graphics:mask_graphics_498,x:313.6,y:149.4}).wait(1).to({graphics:mask_graphics_499,x:313.6,y:149.4}).wait(1).to({graphics:mask_graphics_500,x:313.6,y:149.4}).wait(1).to({graphics:mask_graphics_501,x:313.6,y:149.4}).wait(1).to({graphics:mask_graphics_502,x:313.6,y:149.4}).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(455).to({_off:false},0).wait(1).to({regX:329.3,regY:329.3,x:127.3,y:423.7,alpha:0.333},0).wait(1).to({alpha:0.667},0).wait(1).to({alpha:1},0).wait(1).to({regX:328.9,regY:328.7,x:126.9,y:423.1},0).wait(44));
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	var mask_graphics_435 = new cjs.Graphics().p("EgdIguiIOQoMMA6IBlRIuQIMg");
	var mask_graphics_436 = new cjs.Graphics().p("Eggxgs2IPlpqMA9lBjXIvlJqg");
	var mask_graphics_437 = new cjs.Graphics().p("EgkDgrGIQ2rLMBAoBhYIw1LLg");
	var mask_graphics_438 = new cjs.Graphics().p("EgnOgpQISBsyMBDoBfTIyAMyg");
	var mask_graphics_439 = new cjs.Graphics().p("EgqRgnUITGueMBGjBdHIzGOeg");
	var mask_graphics_440 = new cjs.Graphics().p("EgtNglTIUGwPMBJaBa2I0GQPg");
	var mask_graphics_441 = new cjs.Graphics().p("EgwBgjNIVAyFMBMMBYgI0/SFg");
...
(lib.Scene1_Top = function(mode,startPosition,loop) {
	...
	var mask_graphics_25 = new cjs.Graphics().p("AC5vtIPklZMAMvAk0IvkFZg");
	var mask_graphics_26 = new cjs.Graphics().p("AAwvUIRvmLMAM1Ak0IxvGLg");
	var mask_graphics_27 = new cjs.Graphics().p("AhUu7IT6m8MAM1AkzIz6G8g");
	var mask_graphics_28 = new cjs.Graphics().p("AjYujIWFntMAM1Ak0I2GHtg");
	var mask_graphics_29 = new cjs.Graphics().p("AlcuLIYQodMAM1Ak0I4RIdg");
	var mask_graphics_30 = new cjs.Graphics().p("AngtyIabpOMAM1AkzI6cJOg");
	var mask_graphics_31 = new cjs.Graphics().p("ApktaIcmp+MAM1AkzI8nJ+g");
	var mask_graphics_32 = new cjs.Graphics().p("ArotCIexquMAM0AkzI+yKug");
	var mask_graphics_33 = new cjs.Graphics().p("AttspMAg9gLfMAM0AkyMgg8ALfg");
	var mask_graphics_34 = new cjs.Graphics().p("AvxsRMAjIgMPMAM0AkyMgjHAMPg");
	var mask_graphics_35 = new cjs.Graphics().p("Ax1r4MAlTgNAMAM0AkxMglTANAg");
	var mask_graphics_36 = new cjs.Graphics().p("Az5rgMAnegNwMAM0AkxMgneANwg");
	var mask_graphics_37 = new cjs.Graphics().p("A19rIMAppgOgMAM0AkxMgppAOgg");
	var mask_graphics_38 = new cjs.Graphics().p("A4BqvMAr0gPRMAM0AkwMgr0APRg");
	var mask_graphics_39 = new cjs.Graphics().p("A6GqXMAt/gQCMAM0AkxMgt/AQCg");
	var mask_graphics_40 = new cjs.Graphics().p("A8Kp/MAwKgQyMAM0AkxMgwKAQyg");
	var mask_graphics_41 = new cjs.Graphics().p("A+OpmMAyVgRjMAM0AkwMgyVARjg");
	var mask_graphics_42 = new cjs.Graphics().p("A+UplMAybgRlMAM0AkwMgybARlg");
	var mask_graphics_43 = new cjs.Graphics().p("A+apkMAyigRnMAMzAkwMgyiARng");
	var mask_graphics_44 = new cjs.Graphics().p("A+hpjMAypgRpMAMzAkwMgyoARpg");
	var mask_graphics_45 = new cjs.Graphics().p("A+nphMAyvgRsMAMzAkvMgyuARsg");
	var mask_graphics_46 = new cjs.Graphics().p("A+tpgMAy1gRuMAMzAkvMgy1ARug");
	var mask_graphics_47 = new cjs.Graphics().p("A+zpfMAy7gRwMAMzAkvMgy7ARwg");
	var mask_graphics_48 = new cjs.Graphics().p("A+6peMAzCgRyMAMzAkvMgzBARyg");
	var mask_graphics_49 = new cjs.Graphics().p("A/ApdMAzIgR0MAMzAkvMgzIAR0g");
	var mask_graphics_50 = new cjs.Graphics().p("A/GpbMAzOgR3MAMzAkuMgzOAR3g");
	var mask_graphics_51 = new cjs.Graphics().p("A/MpaMAzUgR5MAMzAkuMgzUAR5g");
	var mask_graphics_52 = new cjs.Graphics().p("A/TpZMAzbgR7MAMzAkuMgzbAR7g");
	var mask_graphics_53 = new cjs.Graphics().p("A/ZpYMAzhgR9MAMzAkuMgzhAR9g");
	var mask_graphics_54 = new cjs.Graphics().p("A/fpXMAzngR/MAMzAkuMgznAR/g");
	var mask_graphics_55 = new cjs.Graphics().p("A//pRMA0wgSPMAMuAkyMg0wASPg");
	var mask_graphics_154 = new cjs.Graphics().p("A//pRMA0wgSPMAMuAkyMg0wASPg");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(18).to({graphics:mask_graphics_18,x:214.1,y:45.5}).wait(1).to({graphics:mask_graphics_19,x:214.2,y:45.5}).wait(1).to({graphics:mask_graphics_20,x:214.2,y:45.5}).wait(1).to({graphics:mask_graphics_21,x:214.2,y:45.5}).wait(1).to({graphics:mask_graphics_22,x:214.2,y:45.5}).wait(1).to({graphics:mask_graphics_23,x:214.2,y:45.5}).wait(1).to({graphics:mask_graphics_24,x:214.2,y:45.5}).wait(1).to({graphics:mask_graphics_25,x:199.6,y:49.9}).wait(1).to({graphics:mask_graphics_26,x:200.4,y:52.1}).wait(1).to({graphics:mask_graphics_27,x:201.1,y:54.3}).wait(1).to({graphics:mask_graphics_28,x:201.8,y:56.5}).wait(1).to({graphics:mask_graphics_29,x:202.5,y:58.8}).wait(1).to({graphics:mask_graphics_30,x:203.2,y:61}).wait(1).to({graphics:mask_graphics_31,x:203.9,y:63.2}).wait(1).to({graphics:mask_graphics_32,x:204.5,y:65.4}).wait(1).to({graphics:mask_graphics_33,x:205.2,y:67.6}).wait(1).to({graphics:mask_graphics_34,x:205.9,y:69.8}).wait(1).to({graphics:mask_graphics_35,x:206.6,y:72}).wait(1).to({graphics:mask_graphics_36,x:207.3,y:74.2}).wait(1).to({graphics:mask_graphics_37,x:208,y:76.4}).wait(1).to({graphics:mask_graphics_38,x:208.7,y:78.6}).wait(1).to({graphics:mask_graphics_39,x:209.3,y:80.8}).wait(1).to({graphics:mask_graphics_40,x:210,y:83}).wait(1).to({graphics:mask_graphics_41,x:210.7,y:85.2}).wait(1).to({graphics:mask_graphics_42,x:210.7,y:85.3}).wait(1).to({graphics:mask_graphics_43,x:210.7,y:85.4}).wait(1).to({graphics:mask_graphics_44,x:210.7,y:85.5}).wait(1).to({graphics:mask_graphics_45,x:210.7,y:85.6}).wait(1).to({graphics:mask_graphics_46,x:210.7,y:85.8}).wait(1).to({graphics:mask_graphics_47,x:210.7,y:85.9}).wait(1).to({graphics:mask_graphics_48,x:210.7,y:86}).wait(1).to({graphics:mask_graphics_49,x:210.7,y:86.1}).wait(1).to({graphics:mask_graphics_50,x:210.7,y:86.2}).wait(1).to({graphics:mask_graphics_51,x:210.7,y:86.3}).wait(1).to({graphics:mask_graphics_52,x:210.7,y:86.4}).wait(1).to({graphics:mask_graphics_53,x:210.7,y:86.5}).wait(1).to({graphics:mask_graphics_54,x:210.7,y:86.6}).wait(1).to({graphics:mask_graphics_55,x:214.3,y:86.5}).wait(99).to({graphics:mask_graphics_154,x:214.3,y:86.6}).wait(1).to({graphics:mask_graphics_155,x:211,y:89.5}).wait(1).to({graphics:mask_graphics_156,x:203,y:92.4}).wait(1).to({graphics:mask_graphics_157,x:195,y:95.3}).wait(1).to({graphics:mask_graphics_158,x:186.9,y:98.2}).wait(1).to({graphics:mask_graphics_159,x:178.9,y:101.1}).wait(1).to({graphics:mask_graphics_160,x:184.6,y:99.1}).wait(1).to({graphics:mask_graphics_161,x:184.6,y:99.1}).wait(1).to({graphics:mask_graphics_162,x:184.6,y:99.1}).wait(1).to({graphics:mask_graphics_163,x:184.6,y:99.1}).wait(1).to({graphics:mask_graphics_164,x:184.6,y:99.1}).wait(1).to({graphics:mask_graphics_165,x:184.6,y:99.1}).wait(1).to({graphics:mask_graphics_166,x:184.6,y:99.1}).wait(1));
...
// stage content:
(lib.CAMC_Journey_Image_300x600 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(45.5,38.3,1.35,1.348,0,0,0,20.4,15.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(477).to({regY:15,scaleY:1.35,y:38.2},0).wait(1).to({regY:19.6,x:45.4,y:44.4,alpha:0.8},0).wait(1).to({alpha:0.6},0).wait(1).to({alpha:0.4},0).wait(1).to({alpha:0.2},0).wait(1).to({alpha:0},0).to({_off:true},1).wait(417));
	...
	this.timeline.addTween(cjs.Tween.get(this.cta_container).wait(553).to({_off:false},0).wait(1).to({regY:348,y:543,alpha:0.167},0).wait(1).to({alpha:0.333},0).wait(1).to({alpha:0.5},0).wait(1).to({alpha:0.667},0).wait(1).to({alpha:0.833},0).wait(1).to({alpha:1},0).wait(1).to({regY:20,y:215},0).wait(340));
	...
	this.timeline.addTween(cjs.Tween.get(this.TextEnd_Container).wait(1).to({regX:148.9,regY:299.2,x:149.9,y:506.2},0).wait(541).to({regX:150,regY:29,x:151,y:236},0).wait(1).to({regX:148.9,regY:299.2,x:149.9,y:504.9,alpha:0.111},0).wait(1).to({y:503.1,alpha:0.222},0).wait(1).to({y:501,alpha:0.333},0).wait(1).to({y:499.3,alpha:0.444},0).wait(1).to({y:498,alpha:0.556},0).wait(1).to({y:497.1,alpha:0.667},0).wait(1).to({y:496.6,alpha:0.778},0).wait(1).to({y:496.3,alpha:0.889},0).wait(1).to({y:496.2,alpha:1},0).wait(1).to({regX:150,regY:29,x:151,y:226},0).wait(348));

	// Logo_morph
	this.instance_1 = new lib.Morphinglogo();
	this.instance_1.parent = this;
	this.instance_1.setTransform(14.7,471.6,1,1,0,0,0,-1.3,423.6);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(456).to({_off:false},0).wait(33).to({y:603.6},0).to({alpha:1},4).to({regX:0,regY:422,scaleX:0.08,scaleY:0.08,x:150,y:348.9},14).wait(393));

	// EndFrame_Grad
	this.instance_2 = new lib.EndFrame_Grad();
	this.instance_2.parent = this;
	this.instance_2.setTransform(150,384.5,1,0.704,0,0,0,150,125);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(520).to({_off:false},0).to({regX:150.1,x:150.1,alpha:0.801},15,cjs.Ease.get(1)).wait(365));
	...
	this.timeline.addTween(cjs.Tween.get(this.IMG_container2).wait(520).to({_off:false},0).wait(1).to({regX:0,regY:0,x:0,y:0,alpha:0.071},0).wait(1).to({alpha:0.143},0).wait(1).to({alpha:0.214},0).wait(1).to({alpha:0.286},0).wait(1).to({alpha:0.357},0).wait(1).to({alpha:0.429},0).wait(1).to({alpha:0.5},0).wait(1).to({alpha:0.571},0).wait(1).to({alpha:0.643},0).wait(1).to({alpha:0.714},0).wait(1).to({alpha:0.786},0).wait(1).to({alpha:0.857},0).wait(1).to({alpha:0.929},0).wait(1).to({alpha:1},0).wait(1).to({regX:150,regY:125,x:150,y:125},0).wait(365));

	// Scene4_Top
	this.instance_3 = new lib.Scene4_Top("synched",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(273.6,544,1,1,0,0,0,257.6,364);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({_off:true},494).wait(406));

	// BG_grad
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["rgba(0,96,112,0)","#006070"],[0,1],-0.1,-240,-0.1,239.9).s().p("EgY/AlgMAAAhK/MAx/AAAMAAABK/g");
	this.shape.setTransform(150,300,0.938,1.25);
	this.shape._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(460).to({_off:false},0).to({_off:true},98).wait(342));

	// Scene4_Bottom
	this.instance_4 = new lib.Scene4_Bottom("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(143.2,603.7,1,1,0,0,0,127.2,423.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({_off:true},494).wait(406));

	// Img mask (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_339 = new cjs.Graphics().p("ALaYZQg4g4AAhPQAAhQA4g3QA4g4BPAAQA0AAArAYQAWANASATQA4A3AABQQAABPg4A4QgSASgWANQgrAZg0AAQhPAAg4g4g");
	var mask_graphics_340 = new cjs.Graphics().p("AgJacQjgjgAAk8QAAk+DgjgQDfjeE8AAQDSAACpBiQBXAyBJBKQDgDgAAE+QAAE8jgDgQhJBKhXA0QipBijSAAQk8AAjfjgg");
	var mask_graphics_341 = new cjs.Graphics().p("ArucfQmImIAAopQAAosGImHQGImFIoAAQFwAAEpCsQCWBXCCCCQGIGHAAIsQAAIpmIGIQiCCCiWBbQkpCrlwAAQooAAmImIg");
	var mask_graphics_342 = new cjs.Graphics().p("A1FejQowowAAsWQAAsaIwowQIworMVAAQINAAGpD1QDXB9C5C5QIwIwAAMaQAAMWowIwQi5C5jXCCQmpD1oNAAQsVAAowowg");
	var mask_graphics_343 = new cjs.Graphics().p("EgbaAgmQrYrYAAwDQAAwJLYrYQLYrRQCAAQKqAAIpE+QEXCjDxDwQLYLYAAQJQAAQDrYLYQjxDwkXCpQopE/qqAAQwCAArYrYg");
	var mask_graphics_344 = new cjs.Graphics().p("EghvAipQuAuAAAzwQAAz3OAuAQOAt4TvAAQNIAAKoGIQFYDIEoEoQOAOAAAT3QAATwuAOAQkoEolYDQQqoGItIAAQzvAAuAuAg");
	...
	var mask_graphics_427 = new cjs.Graphics().p("EgfBAhtQs4s4AAyKQAAyRM4s4QM4sxSJAAQMFAAJxFpQE8C4EQEQQM4M4AASRQAASKs4M4QkQEQk8DAQpxFosFAAQyJAAs4s4g");
	var mask_graphics_428 = new cjs.Graphics().p("A3zfYQp4p4AAt7QAAuBJ4p4QJ4pyN7AAQJRAAHfEVQDzCNDRDQQJ4J4AAOBQAAN7p4J4QjRDRjzCTQnfEUpRAAQt7AAp4p4g");
	var mask_graphics_429 = new cjs.Graphics().p("AvBdDQm4m4AApsQAApxG4m3QG4m0JrAAQGdAAFODAQCpBjCRCRQG4G3AAJxQAAJsm4G4QiRCSipBmQlODAmdAAQprAAm4m4g");
	var mask_graphics_430 = new cjs.Graphics().p("AhzauQj4j4AAleQAAlgD4j4QD3j1FeAAQDoAAC9BsQBfA3BSBSQD4D4AAFgQAAFej4D4QhSBShfA6Qi9BsjoAAQleAAj3j4g");
	var mask_graphics_431 = new cjs.Graphics().p("ALaYZQg4g4AAhPQAAhPA4g4QA4g4BPAAQA1AAAqAZQAVAMATATQA4A4AABPQAABPg4A4QgTASgVANQgqAZg1AAQhPAAg4g4g");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(339).to({graphics:mask_graphics_339,x:105.6,y:161.7}).wait(1).to({graphics:mask_graphics_340,x:129.3,y:191.6}).wait(1).to({graphics:mask_graphics_341,x:153.1,y:221.5}).wait(1).to({graphics:mask_graphics_342,x:162.7,y:251.5}).wait(1).to({graphics:mask_graphics_343,x:152.9,y:281.4}).wait(1).to({graphics:mask_graphics_344,x:143.1,y:311.3}).wait(1).to({graphics:mask_graphics_345,x:133.3,y:319.5}).wait(1).to({graphics:mask_graphics_346,x:123.5,y:322.1}).wait(1).to({graphics:mask_graphics_347,x:113.7,y:323.4}).wait(77).to({graphics:mask_graphics_424,x:113.7,y:323.4}).wait(1).to({graphics:mask_graphics_425,x:124.9,y:320.6}).wait(1).to({graphics:mask_graphics_426,x:136.1,y:317.9}).wait(1).to({graphics:mask_graphics_427,x:147.3,y:298.1}).wait(1).to({graphics:mask_graphics_428,x:158.5,y:264}).wait(1).to({graphics:mask_graphics_429,x:159.9,y:229.9}).wait(1).to({graphics:mask_graphics_430,x:132.8,y:195.8}).wait(1).to({graphics:mask_graphics_431,x:105.6,y:161.7}).wait(469));
	...
	this.timeline.addTween(cjs.Tween.get(this.locationTitleContainer).wait(353).to({y:566.6,alpha:0.801},4).to({y:562.6,alpha:1},1).wait(66).to({y:542.6,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(468));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(348).to({_off:false},0).to({regX:150.2,x:150.2,alpha:0.699},5,cjs.Ease.get(1)).wait(71).to({regX:150,x:151},0).wait(1).to({alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(468));
	...
	this.instance_6.setTransform(211.2,323.4,1,1,0,0,0,19.1,19.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(339).to({_off:false},0).to({regY:19.2,scaleX:25,scaleY:25,x:591.2,y:803.4},8).wait(77).to({regY:19.1,y:800.9},0).to({regX:19.2,regY:19.2,scaleX:1,scaleY:1,x:211.3,y:323.5},7).to({_off:true},1).wait(468));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(1).to({regY:206.9,y:446.9,startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:5},0).wait(1).to({startPosition:6},0).wait(1).to({startPosition:7},0).wait(1).to({startPosition:8},0).wait(1).to({startPosition:9},0).wait(1).to({startPosition:10},0).wait(1).to({startPosition:11},0).wait(1).to({startPosition:12},0).wait(1).to({startPosition:13},0).wait(1).to({startPosition:14},0).wait(1).to({startPosition:15},0).wait(1).to({startPosition:16},0).wait(1).to({startPosition:17},0).wait(1).to({startPosition:18},0).wait(1).to({startPosition:19},0).wait(1).to({startPosition:20},0).wait(1).to({startPosition:21},0).wait(1).to({startPosition:22},0).wait(1).to({startPosition:23},0).wait(1).to({startPosition:24},0).wait(1).to({startPosition:25},0).wait(1).to({startPosition:26},0).wait(1).to({startPosition:27},0).wait(1).to({startPosition:28},0).wait(1).to({startPosition:29},0).wait(1).to({startPosition:30},0).wait(1).to({startPosition:31},0).wait(1).to({startPosition:32},0).wait(1).to({startPosition:33},0).wait(1).to({startPosition:34},0).wait(1).to({startPosition:35},0).wait(1).to({startPosition:36},0).wait(1).to({startPosition:37},0).wait(1).to({startPosition:38},0).wait(1).to({startPosition:39},0).wait(1).to({startPosition:40},0).wait(1).to({startPosition:41},0).wait(1).to({startPosition:42},0).wait(1).to({startPosition:43},0).wait(1).to({startPosition:44},0).wait(1).to({startPosition:45},0).wait(1).to({startPosition:46},0).wait(1).to({startPosition:47},0).wait(1).to({startPosition:48},0).wait(1).to({startPosition:49},0).wait(1).to({startPosition:50},0).wait(1).to({startPosition:51},0).wait(1).to({startPosition:52},0).wait(1).to({startPosition:53},0).wait(1).to({startPosition:54},0).wait(1).to({startPosition:55},0).wait(1).to({startPosition:56},0).wait(1).to({startPosition:57},0).wait(1).to({startPosition:58},0).wait(1).to({startPosition:59},0).wait(1).to({startPosition:60},0).wait(1).to({startPosition:61},0).wait(1).to({startPosition:62},0).wait(1).to({startPosition:63},0).wait(1).to({startPosition:64},0).wait(1).to({startPosition:65},0).wait(1).to({startPosition:66},0).wait(1).to({startPosition:67},0).wait(1).to({startPosition:68},0).wait(1).to({startPosition:69},0).wait(1).to({startPosition:70},0).wait(1).to({startPosition:71},0).wait(1).to({startPosition:72},0).wait(1).to({startPosition:73},0).wait(1).to({startPosition:74},0).wait(1).to({startPosition:75},0).wait(1).to({startPosition:76},0).wait(1).to({startPosition:77},0).wait(1).to({startPosition:78},0).wait(1).to({startPosition:79},0).wait(1).to({startPosition:80},0).wait(1).to({startPosition:81},0).wait(1).to({startPosition:82},0).wait(1).to({startPosition:83},0).wait(1).to({startPosition:84},0).wait(1).to({startPosition:85},0).wait(1).to({startPosition:86},0).wait(1).to({startPosition:87},0).wait(1).to({startPosition:88},0).wait(1).to({startPosition:89},0).wait(1).to({startPosition:90},0).wait(1).to({startPosition:91},0).wait(1).to({startPosition:92},0).wait(1).to({startPosition:93},0).wait(1).to({startPosition:94},0).wait(1).to({startPosition:95},0).wait(1).to({startPosition:96},0).wait(1).to({startPosition:97},0).wait(1).to({startPosition:98},0).wait(1).to({startPosition:99},0).wait(1).to({startPosition:100},0).wait(1).to({startPosition:101},0).wait(1).to({startPosition:102},0).wait(1).to({startPosition:103},0).wait(1).to({startPosition:104},0).wait(1).to({startPosition:105},0).wait(1).to({startPosition:106},0).wait(1).to({startPosition:107},0).wait(1).to({startPosition:108},0).wait(1).to({startPosition:109},0).wait(1).to({startPosition:110},0).wait(1).to({startPosition:111},0).wait(1).to({startPosition:112},0).wait(1).to({startPosition:113},0).wait(1).to({startPosition:114},0).wait(1).to({startPosition:115},0).wait(1).to({startPosition:116},0).wait(1).to({startPosition:117},0).wait(1).to({startPosition:118},0).wait(1).to({startPosition:119},0).wait(1).to({startPosition:120},0).wait(1).to({startPosition:121},0).wait(1).to({startPosition:122},0).wait(1).to({startPosition:123},0).wait(1).to({startPosition:124},0).wait(1).to({startPosition:125},0).wait(1).to({startPosition:126},0).wait(1).to({startPosition:127},0).wait(1).to({startPosition:128},0).wait(1).to({startPosition:129},0).wait(1).to({startPosition:130},0).wait(1).to({startPosition:131},0).wait(1).to({startPosition:132},0).wait(1).to({startPosition:133},0).wait(1).to({startPosition:134},0).wait(1).to({startPosition:135},0).wait(1).to({startPosition:136},0).wait(1).to({startPosition:137},0).wait(1).to({startPosition:138},0).wait(1).to({startPosition:139},0).wait(1).to({startPosition:140},0).wait(1).to({startPosition:141},0).wait(1).to({startPosition:142},0).wait(1).to({startPosition:143},0).wait(1).to({startPosition:144},0).wait(1).to({startPosition:145},0).wait(1).to({startPosition:146},0).wait(1).to({startPosition:147},0).wait(1).to({startPosition:148},0).wait(1).to({startPosition:149},0).wait(1).to({startPosition:150},0).wait(1).to({startPosition:151},0).wait(1).to({startPosition:152},0).wait(1).to({startPosition:153},0).wait(1).to({startPosition:154},0).wait(1).to({startPosition:155},0).wait(1).to({startPosition:156},0).wait(1).to({startPosition:157},0).wait(1).to({startPosition:158},0).wait(1).to({startPosition:159},0).wait(1).to({startPosition:160},0).wait(1).to({startPosition:161},0).wait(1).to({startPosition:162},0).wait(1).to({startPosition:163},0).wait(1).to({startPosition:164},0).wait(1).to({startPosition:165},0).wait(1).to({startPosition:166},0).wait(1).to({startPosition:167},0).wait(1).to({startPosition:168},0).wait(1).to({startPosition:169},0).wait(1).to({startPosition:170},0).wait(1).to({startPosition:171},0).wait(1).to({startPosition:172},0).wait(1).to({startPosition:173},0).wait(1).to({startPosition:174},0).wait(1).to({startPosition:175},0).wait(1).to({startPosition:176},0).wait(1).to({startPosition:177},0).wait(1).to({startPosition:178},0).wait(1).to({startPosition:179},0).wait(1).to({startPosition:180},0).wait(1).to({startPosition:181},0).wait(1).to({startPosition:182},0).wait(1).to({startPosition:183},0).wait(1).to({startPosition:184},0).wait(1).to({startPosition:185},0).wait(1).to({startPosition:186},0).wait(1).to({startPosition:187},0).wait(1).to({startPosition:188},0).wait(1).to({startPosition:189},0).wait(1).to({startPosition:190},0).wait(1).to({startPosition:191},0).wait(1).to({startPosition:192},0).wait(1).to({startPosition:193},0).wait(1).to({startPosition:194},0).wait(1).to({startPosition:195},0).wait(1).to({startPosition:196},0).wait(1).to({startPosition:197},0).wait(1).to({startPosition:198},0).wait(1).to({startPosition:199},0).wait(1).to({startPosition:200},0).wait(1).to({startPosition:201},0).wait(1).to({startPosition:202},0).wait(1).to({startPosition:203},0).wait(1).to({startPosition:204},0).wait(1).to({startPosition:205},0).wait(1).to({startPosition:206},0).wait(1).to({startPosition:207},0).wait(1).to({startPosition:208},0).wait(1).to({startPosition:209},0).wait(1).to({startPosition:210},0).wait(1).to({startPosition:211},0).wait(1).to({startPosition:212},0).wait(1).to({startPosition:213},0).wait(1).to({startPosition:214},0).wait(1).to({startPosition:215},0).wait(1).to({startPosition:216},0).wait(1).to({startPosition:217},0).wait(1).to({startPosition:218},0).wait(1).to({startPosition:219},0).wait(1).to({startPosition:220},0).wait(1).to({startPosition:221},0).wait(1).to({startPosition:222},0).wait(1).to({startPosition:223},0).wait(1).to({startPosition:224},0).wait(1).to({startPosition:225},0).wait(1).to({startPosition:226},0).wait(1).to({startPosition:227},0).wait(1).to({startPosition:228},0).wait(1).to({startPosition:229},0).wait(1).to({startPosition:230},0).wait(1).to({startPosition:231},0).wait(1).to({startPosition:232},0).wait(1).to({startPosition:233},0).wait(1).to({startPosition:234},0).wait(1).to({startPosition:235},0).wait(1).to({startPosition:236},0).wait(1).to({startPosition:237},0).wait(1).to({startPosition:238},0).wait(1).to({startPosition:239},0).wait(1).to({startPosition:240},0).wait(1).to({startPosition:241},0).wait(1).to({startPosition:242},0).wait(1).to({startPosition:243},0).wait(1).to({startPosition:244},0).wait(1).to({startPosition:245},0).wait(1).to({startPosition:246},0).wait(1).to({startPosition:247},0).wait(1).to({startPosition:248},0).wait(1).to({startPosition:249},0).wait(1).to({startPosition:250},0).wait(1).to({startPosition:251},0).wait(1).to({startPosition:252},0).wait(1).to({startPosition:253},0).wait(1).to({startPosition:254},0).wait(1).to({startPosition:255},0).wait(1).to({startPosition:256},0).wait(1).to({startPosition:257},0).wait(1).to({startPosition:258},0).wait(1).to({startPosition:259},0).wait(1).to({startPosition:260},0).wait(1).to({startPosition:261},0).wait(1).to({startPosition:262},0).wait(1).to({startPosition:263},0).wait(1).to({startPosition:264},0).wait(1).to({startPosition:265},0).wait(1).to({startPosition:266},0).wait(1).to({startPosition:267},0).wait(1).to({startPosition:268},0).wait(1).to({startPosition:269},0).wait(1).to({startPosition:270},0).wait(1).to({startPosition:271},0).wait(1).to({startPosition:272},0).wait(1).to({startPosition:273},0).wait(1).to({startPosition:274},0).wait(1).to({startPosition:275},0).wait(1).to({startPosition:276},0).wait(1).to({startPosition:277},0).wait(1).to({startPosition:278},0).wait(1).to({startPosition:279},0).wait(1).to({startPosition:280},0).wait(1).to({startPosition:281},0).wait(1).to({startPosition:282},0).wait(1).to({startPosition:283},0).wait(1).to({startPosition:284},0).wait(1).to({startPosition:285},0).wait(1).to({startPosition:286},0).wait(1).to({startPosition:287},0).wait(1).to({startPosition:288},0).wait(1).to({startPosition:289},0).wait(1).to({startPosition:290},0).wait(1).to({startPosition:291},0).wait(1).to({startPosition:292},0).wait(1).to({startPosition:293},0).wait(1).to({startPosition:294},0).wait(1).to({startPosition:295},0).wait(1).to({startPosition:296},0).wait(1).to({startPosition:297},0).wait(1).to({startPosition:298},0).wait(1).to({startPosition:299},0).wait(1).to({startPosition:300},0).wait(1).to({startPosition:301},0).wait(1).to({startPosition:302},0).wait(1).to({startPosition:303},0).wait(1).to({startPosition:304},0).wait(1).to({startPosition:305},0).wait(1).to({startPosition:306},0).wait(1).to({startPosition:307},0).wait(1).to({startPosition:308},0).wait(1).to({startPosition:309},0).wait(1).to({startPosition:310},0).wait(1).to({startPosition:311},0).wait(1).to({startPosition:312},0).wait(1).to({startPosition:313},0).wait(1).to({startPosition:314},0).wait(1).to({startPosition:315},0).wait(1).to({startPosition:316},0).wait(1).to({startPosition:317},0).wait(1).to({startPosition:318},0).wait(1).to({startPosition:319},0).wait(1).to({startPosition:320},0).wait(1).to({startPosition:321},0).wait(1).to({startPosition:322},0).wait(1).to({startPosition:323},0).wait(1).to({startPosition:324},0).wait(1).to({startPosition:325},0).wait(1).to({startPosition:326},0).wait(1).to({startPosition:327},0).wait(1).to({startPosition:328},0).wait(1).to({startPosition:329},0).wait(1).to({startPosition:330},0).wait(1).to({startPosition:331},0).wait(1).to({startPosition:332},0).wait(1).to({startPosition:333},0).wait(1).to({startPosition:334},0).wait(1).to({startPosition:335},0).wait(1).to({startPosition:336},0).wait(1).to({startPosition:337},0).wait(1).to({startPosition:338},0).wait(1).to({startPosition:339},0).wait(1).to({scaleX:2.73,scaleY:2.73,x:607.3,y:694.1,startPosition:340},0).wait(1).to({scaleX:4.45,scaleY:4.45,x:866.5,y:941.4,startPosition:341},0).wait(1).to({scaleX:6.18,scaleY:6.18,x:1125.7,y:1188.6,startPosition:342},0).wait(1).to({scaleX:7.9,scaleY:7.9,x:1384.8,y:1435.9,startPosition:343},0).wait(1).to({scaleX:9.63,scaleY:9.63,x:1643.9,y:1683.1,startPosition:344},0).wait(1).to({scaleX:11.35,scaleY:11.35,x:1903.1,y:1930.3,startPosition:345},0).wait(1).to({startPosition:346},0).wait(1).to({startPosition:347},0).wait(1).to({startPosition:348},0).wait(1).to({startPosition:349},0).wait(1).to({startPosition:350},0).wait(1).to({startPosition:351},0).wait(1).to({startPosition:352},0).wait(1).to({startPosition:353},0).wait(1).to({startPosition:354},0).wait(1).to({startPosition:355},0).wait(1).to({startPosition:356},0).wait(1).to({startPosition:357},0).wait(1).to({startPosition:358},0).wait(1).to({startPosition:359},0).wait(1).to({startPosition:360},0).wait(1).to({startPosition:361},0).wait(1).to({startPosition:362},0).wait(1).to({startPosition:363},0).wait(1).to({startPosition:364},0).wait(1).to({startPosition:365},0).wait(1).to({startPosition:366},0).wait(1).to({startPosition:367},0).wait(1).to({startPosition:368},0).wait(1).to({startPosition:369},0).wait(1).to({startPosition:370},0).wait(1).to({startPosition:371},0).wait(1).to({startPosition:372},0).wait(1).to({startPosition:373},0).wait(1).to({startPosition:374},0).wait(1).to({startPosition:375},0).wait(1).to({startPosition:376},0).wait(1).to({startPosition:377},0).wait(1).to({startPosition:378},0).wait(1).to({startPosition:379},0).wait(1).to({startPosition:380},0).wait(1).to({startPosition:381},0).wait(1).to({startPosition:382},0).wait(1).to({startPosition:383},0).wait(1).to({startPosition:384},0).wait(1).to({startPosition:385},0).wait(1).to({startPosition:386},0).wait(1).to({startPosition:387},0).wait(1).to({startPosition:388},0).wait(1).to({startPosition:389},0).wait(1).to({startPosition:390},0).wait(1).to({startPosition:391},0).wait(1).to({startPosition:392},0).wait(1).to({startPosition:393},0).wait(1).to({startPosition:394},0).wait(1).to({startPosition:395},0).wait(1).to({startPosition:396},0).wait(1).to({startPosition:397},0).wait(1).to({startPosition:398},0).wait(1).to({startPosition:399},0).wait(1).to({startPosition:400},0).wait(1).to({startPosition:401},0).wait(1).to({startPosition:402},0).wait(1).to({startPosition:403},0).wait(1).to({startPosition:404},0).wait(1).to({startPosition:405},0).wait(1).to({startPosition:406},0).wait(1).to({startPosition:407},0).wait(1).to({startPosition:408},0).wait(1).to({startPosition:409},0).wait(1).to({startPosition:410},0).wait(1).to({startPosition:411},0).wait(1).to({startPosition:412},0).wait(1).to({startPosition:413},0).wait(1).to({startPosition:414},0).wait(1).to({startPosition:415},0).wait(1).to({startPosition:416},0).wait(1).to({startPosition:417},0).wait(1).to({startPosition:418},0).wait(1).to({startPosition:419},0).wait(1).to({startPosition:420},0).wait(1).to({startPosition:421},0).wait(1).to({startPosition:422},0).wait(1).to({startPosition:423},0).wait(1).to({startPosition:424},0).wait(1).to({scaleX:9.63,scaleY:9.63,x:1643.9,y:1683.1,startPosition:425},0).wait(1).to({scaleX:7.9,scaleY:7.9,x:1384.8,y:1435.9,startPosition:426},0).wait(1).to({scaleX:6.18,scaleY:6.18,x:1125.7,y:1188.6,startPosition:427},0).wait(1).to({scaleX:4.45,scaleY:4.45,x:866.5,y:941.4,startPosition:428},0).wait(1).to({scaleX:2.73,scaleY:2.73,x:607.3,y:694.1,startPosition:429},0).wait(1).to({scaleX:1,scaleY:1,x:348.2,y:446.9,startPosition:430},0).wait(1).to({startPosition:431},0).wait(1).to({startPosition:432},0).wait(1).to({startPosition:433},0).wait(1).to({startPosition:434},0).wait(1).to({startPosition:435},0).wait(1).to({startPosition:436},0).wait(1).to({startPosition:437},0).wait(1).to({startPosition:438},0).wait(1).to({startPosition:439},0).wait(1).to({startPosition:440},0).wait(1).to({startPosition:441},0).wait(1).to({startPosition:442},0).wait(1).to({startPosition:443},0).wait(1).to({startPosition:444},0).wait(1).to({startPosition:445},0).wait(1).to({startPosition:446},0).wait(1).to({startPosition:447},0).wait(1).to({startPosition:448},0).wait(1).to({startPosition:449},0).wait(1).to({startPosition:450},0).wait(1).to({startPosition:451},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:3},0).wait(1).to({startPosition:4},0).wait(1).to({startPosition:5},0).wait(1).to({startPosition:6},0).wait(1).to({startPosition:7},0).to({_off:true},1).wait(440));
	...
	this.timeline.addTween(cjs.Tween.get(this.Text3_Container).wait(1).to({regX:110,regY:329.5,x:186,y:417.3},0).wait(206).to({regX:150,regY:72.5,x:226,y:130.3},0).wait(1).to({regX:110,regY:329.5,x:186,y:387.3,alpha:0.333},0).wait(1).to({alpha:0.667},0).wait(1).to({alpha:1},0).wait(1).to({regX:150,regY:72.5,x:226,y:130.3},0).wait(82).to({regX:110,regY:329.5,x:186,y:387.3,alpha:0.5},0).wait(1).to({alpha:0},0).to({_off:true},1).wait(3).to({_off:false,regX:150,regY:72.5,x:226,y:160.3},0).to({_off:true},12).wait(590));

	// Scene2_Top
	this.instance_9 = new lib.Scene2_Top("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(-2.3,322.7,1,1,0,0,0,-22.3,124.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1).to({regX:118.9,regY:-61.3,x:138.9,y:137.7,startPosition:1},0).wait(1).to({y:138.3,startPosition:2},0).wait(1).to({y:138.8,startPosition:3},0).wait(1).to({y:139.3,startPosition:4},0).wait(1).to({y:139.9,startPosition:5},0).wait(1).to({y:140.4,startPosition:6},0).wait(1).to({y:140.9,startPosition:7},0).wait(1).to({y:141.4,startPosition:8},0).wait(1).to({y:142,startPosition:9},0).wait(1).to({y:142.5,startPosition:10},0).wait(1).to({y:143,startPosition:11},0).wait(1).to({y:143.6,startPosition:12},0).wait(1).to({y:144.1,startPosition:13},0).wait(1).to({y:144.6,startPosition:14},0).wait(1).to({y:145.2,startPosition:15},0).wait(1).to({y:145.7,startPosition:16},0).wait(1).to({y:146.2,startPosition:17},0).wait(1).to({y:146.7,startPosition:18},0).wait(1).to({y:147.3,startPosition:19},0).wait(1).to({y:147.8,startPosition:20},0).wait(1).to({y:148.3,startPosition:21},0).wait(1).to({y:148.9,startPosition:22},0).wait(1).to({y:149.4,startPosition:23},0).wait(1).to({y:149.9,startPosition:24},0).wait(1).to({y:150.5,startPosition:25},0).wait(1).to({y:151,startPosition:26},0).wait(1).to({y:151.5,startPosition:27},0).wait(1).to({y:152,startPosition:28},0).wait(1).to({y:152.6,startPosition:29},0).wait(1).to({y:153.1,startPosition:30},0).wait(1).to({y:153.6,startPosition:31},0).wait(1).to({y:154.2,startPosition:32},0).wait(1).to({y:154.7,startPosition:33},0).wait(1).to({y:155.2,startPosition:34},0).wait(1).to({y:155.8,startPosition:35},0).wait(1).to({y:156.3,startPosition:36},0).wait(1).to({y:156.8,startPosition:37},0).wait(1).to({y:157.3,startPosition:38},0).wait(1).to({y:157.9,startPosition:39},0).wait(1).to({y:158.4,startPosition:40},0).wait(1).to({y:158.9,startPosition:41},0).wait(1).to({y:159.5,startPosition:42},0).wait(1).to({y:160,startPosition:43},0).wait(1).to({y:160.5,startPosition:44},0).wait(1).to({y:161.1,startPosition:45},0).wait(1).to({y:161.6,startPosition:46},0).wait(1).to({y:162.1,startPosition:47},0).wait(1).to({y:162.6,startPosition:48},0).wait(1).to({y:163.2,startPosition:49},0).wait(1).to({y:163.7,startPosition:50},0).wait(1).to({y:164.2,startPosition:51},0).wait(1).to({y:164.8,startPosition:52},0).wait(1).to({y:165.3,startPosition:53},0).wait(1).to({y:165.8,startPosition:54},0).wait(1).to({y:166.4,startPosition:55},0).wait(1).to({y:166.9,startPosition:56},0).wait(1).to({y:167.4,startPosition:57},0).wait(1).to({y:167.9,startPosition:58},0).wait(1).to({y:168.5,startPosition:59},0).wait(1).to({y:169,startPosition:60},0).wait(1).to({y:169.5,startPosition:61},0).wait(1).to({y:170.1,startPosition:62},0).wait(1).to({y:170.6,startPosition:63},0).wait(1).to({y:171.1,startPosition:64},0).wait(1).to({y:171.7,startPosition:65},0).wait(1).to({y:172.2,startPosition:66},0).wait(1).to({y:172.7,startPosition:67},0).wait(1).to({y:173.2,startPosition:68},0).wait(1).to({y:173.8,startPosition:69},0).wait(1).to({y:174.3,startPosition:70},0).wait(1).to({y:174.8,startPosition:71},0).wait(1).to({y:175.4,startPosition:72},0).wait(1).to({y:175.9,startPosition:73},0).wait(1).to({y:176.4,startPosition:74},0).wait(1).to({y:177,startPosition:75},0).wait(1).to({y:177.5,startPosition:76},0).wait(1).to({y:178,startPosition:77},0).wait(1).to({y:178.5,startPosition:78},0).wait(1).to({y:179.1,startPosition:79},0).wait(1).to({y:179.6,startPosition:80},0).wait(1).to({y:180.1,startPosition:81},0).wait(1).to({y:180.7,startPosition:82},0).wait(1).to({y:181.2,startPosition:83},0).wait(1).to({y:181.7,startPosition:84},0).wait(1).to({y:182.3,startPosition:85},0).wait(1).to({y:182.8,startPosition:86},0).wait(1).to({y:183.3,startPosition:87},0).wait(1).to({y:183.9,startPosition:88},0).wait(1).to({y:184.4,startPosition:89},0).wait(1).to({y:184.9,startPosition:90},0).wait(1).to({y:185.4,startPosition:91},0).wait(1).to({y:186,startPosition:92},0).wait(1).to({y:186.5,startPosition:93},0).wait(1).to({y:187,startPosition:94},0).wait(1).to({y:187.6,startPosition:95},0).wait(1).to({y:188.1,startPosition:96},0).wait(1).to({y:188.6,startPosition:97},0).wait(1).to({y:189.2,startPosition:98},0).wait(1).to({y:189.7,startPosition:99},0).wait(1).to({y:190.2,startPosition:100},0).wait(1).to({y:190.7,startPosition:101},0).wait(1).to({y:191.3,startPosition:102},0).wait(1).to({y:191.8,startPosition:103},0).wait(1).to({y:192.3,startPosition:104},0).wait(1).to({y:192.9,startPosition:105},0).wait(1).to({y:193.4,startPosition:106},0).wait(1).to({y:193.9,startPosition:107},0).wait(1).to({y:194.5,startPosition:108},0).wait(1).to({y:195,startPosition:109},0).wait(1).to({y:195.5,startPosition:110},0).wait(1).to({y:196,startPosition:111},0).wait(1).to({y:196.6,startPosition:112},0).wait(1).to({y:197.1,startPosition:113},0).wait(1).to({y:197.6,startPosition:114},0).wait(1).to({y:198.2,startPosition:115},0).wait(1).to({y:198.7,startPosition:116},0).wait(1).to({y:199.2,startPosition:117},0).wait(1).to({y:199.8,startPosition:118},0).wait(1).to({y:200.3,startPosition:119},0).wait(1).to({y:200.8,startPosition:120},0).wait(1).to({y:201.3,startPosition:121},0).wait(1).to({y:201.9,startPosition:122},0).wait(1).to({y:202.4,startPosition:123},0).wait(1).to({y:202.9,startPosition:124},0).wait(1).to({y:203.5,startPosition:125},0).wait(1).to({y:204,startPosition:126},0).wait(1).to({y:204.5,startPosition:127},0).wait(1).to({y:205.1,startPosition:128},0).wait(1).to({y:205.6,startPosition:129},0).wait(1).to({y:206.1,startPosition:130},0).wait(1).to({y:206.6,startPosition:131},0).wait(1).to({y:207.2,startPosition:132},0).wait(1).to({y:207.7,startPosition:133},0).wait(1).to({y:208.2,startPosition:134},0).wait(1).to({y:208.8,startPosition:135},0).wait(1).to({y:209.3,startPosition:136},0).wait(1).to({y:209.8,startPosition:137},0).wait(1).to({y:210.4,startPosition:138},0).wait(1).to({y:210.9,startPosition:139},0).wait(1).to({y:211.4,startPosition:140},0).wait(1).to({y:211.9,startPosition:141},0).wait(1).to({y:212.5,startPosition:142},0).wait(1).to({y:213,startPosition:143},0).wait(1).to({y:213.5,startPosition:144},0).wait(1).to({y:214.1,startPosition:145},0).wait(1).to({y:214.6,startPosition:146},0).wait(1).to({y:215.1,startPosition:147},0).wait(1).to({y:215.7,startPosition:148},0).wait(1).to({y:216.2,startPosition:149},0).wait(1).to({y:216.7,startPosition:150},0).wait(1).to({y:217.2,startPosition:151},0).wait(1).to({y:217.8,startPosition:152},0).wait(1).to({y:218.3,startPosition:153},0).wait(1).to({y:218.8,startPosition:154},0).wait(1).to({y:219.4,startPosition:155},0).wait(1).to({y:219.9,startPosition:156},0).wait(1).to({y:220.4,startPosition:157},0).wait(1).to({y:221,startPosition:158},0).wait(1).to({y:221.5,startPosition:159},0).wait(1).to({y:222,startPosition:160},0).wait(1).to({y:222.5,startPosition:161},0).wait(1).to({y:223.1,startPosition:162},0).wait(1).to({y:223.6,startPosition:163},0).wait(1).to({y:224.1,startPosition:164},0).wait(1).to({y:224.7,startPosition:165},0).wait(1).to({y:225.2,startPosition:166},0).wait(1).to({startPosition:167},0).wait(1).to({startPosition:168},0).wait(1).to({startPosition:169},0).wait(1).to({startPosition:170},0).wait(1).to({startPosition:171},0).wait(1).to({startPosition:172},0).wait(1).to({startPosition:173},0).wait(1).to({startPosition:174},0).wait(1).to({startPosition:175},0).wait(1).to({startPosition:176},0).wait(1).to({startPosition:177},0).wait(1).to({startPosition:178},0).wait(1).to({startPosition:179},0).wait(1).to({startPosition:180},0).wait(1).to({startPosition:181},0).wait(1).to({startPosition:182},0).wait(1).to({startPosition:183},0).wait(1).to({startPosition:184},0).wait(1).to({startPosition:185},0).wait(1).to({startPosition:186},0).wait(1).to({startPosition:187},0).wait(1).to({startPosition:188},0).wait(1).to({startPosition:189},0).wait(1).to({startPosition:190},0).wait(1).to({startPosition:191},0).wait(1).to({startPosition:192},0).wait(1).to({startPosition:193},0).wait(1).to({startPosition:194},0).wait(1).to({startPosition:195},0).wait(1).to({startPosition:196},0).wait(1).to({startPosition:197},0).wait(1).to({startPosition:198},0).wait(1).to({startPosition:199},0).wait(1).to({startPosition:200},0).wait(1).to({startPosition:201},0).wait(1).to({startPosition:202},0).wait(1).to({startPosition:203},0).wait(1).to({scaleX:3.78,scaleY:3.78,x:-217.5,y:-463,startPosition:204},0).wait(1).to({scaleX:6.57,scaleY:6.57,x:-573.9,y:-1151.3,startPosition:205},0).wait(1).to({scaleX:9.35,scaleY:9.35,x:-930.3,y:-1839.6,startPosition:206},0).wait(1).to({scaleX:12.13,scaleY:12.13,x:-1286.7,y:-2527.9,startPosition:207},0).wait(1).to({startPosition:208},0).wait(1).to({startPosition:209},0).wait(1).to({startPosition:210},0).wait(1).to({startPosition:211},0).wait(1).to({startPosition:212},0).wait(1).to({startPosition:213},0).wait(1).to({startPosition:214},0).wait(1).to({startPosition:215},0).wait(1).to({startPosition:216},0).wait(1).to({startPosition:217},0).wait(1).to({startPosition:218},0).wait(1).to({startPosition:219},0).wait(1).to({startPosition:220},0).wait(1).to({startPosition:221},0).wait(1).to({startPosition:222},0).wait(1).to({startPosition:223},0).wait(1).to({startPosition:224},0).wait(1).to({startPosition:225},0).wait(1).to({startPosition:226},0).wait(1).to({startPosition:227},0).wait(1).to({startPosition:228},0).wait(1).to({startPosition:229},0).wait(1).to({startPosition:230},0).wait(1).to({startPosition:231},0).wait(1).to({startPosition:232},0).wait(1).to({startPosition:233},0).wait(1).to({startPosition:234},0).wait(1).to({startPosition:235},0).wait(1).to({startPosition:236},0).wait(1).to({startPosition:237},0).wait(1).to({startPosition:238},0).wait(1).to({startPosition:239},0).wait(1).to({startPosition:240},0).wait(1).to({startPosition:241},0).wait(1).to({startPosition:242},0).wait(1).to({startPosition:243},0).wait(1).to({startPosition:244},0).wait(1).to({startPosition:245},0).wait(1).to({startPosition:246},0).wait(1).to({startPosition:247},0).wait(1).to({startPosition:248},0).wait(1).to({startPosition:249},0).wait(1).to({startPosition:250},0).wait(1).to({startPosition:251},0).wait(1).to({startPosition:252},0).wait(1).to({startPosition:253},0).wait(1).to({startPosition:254},0).wait(1).to({startPosition:255},0).wait(1).to({startPosition:256},0).wait(1).to({startPosition:257},0).wait(1).to({startPosition:258},0).wait(1).to({startPosition:259},0).wait(1).to({startPosition:260},0).wait(1).to({startPosition:261},0).wait(1).to({startPosition:262},0).wait(1).to({startPosition:263},0).wait(1).to({startPosition:264},0).wait(1).to({startPosition:265},0).wait(1).to({startPosition:266},0).wait(1).to({startPosition:267},0).wait(1).to({startPosition:268},0).wait(1).to({startPosition:269},0).wait(1).to({startPosition:270},0).wait(1).to({startPosition:271},0).wait(1).to({startPosition:272},0).wait(1).to({startPosition:273},0).wait(1).to({startPosition:274},0).wait(1).to({startPosition:275},0).wait(1).to({startPosition:276},0).wait(1).to({startPosition:277},0).wait(1).to({startPosition:278},0).wait(1).to({startPosition:279},0).wait(1).to({startPosition:280},0).wait(1).to({startPosition:281},0).wait(1).to({startPosition:282},0).wait(1).to({startPosition:283},0).wait(1).to({startPosition:284},0).wait(1).to({startPosition:285},0).wait(1).to({startPosition:286},0).wait(1).to({startPosition:287},0).wait(1).to({startPosition:288},0).wait(1).to({startPosition:289},0).wait(1).to({startPosition:290},0).wait(1).to({startPosition:291},0).wait(1).to({startPosition:292},0).wait(1).to({startPosition:293},0).wait(1).to({scaleX:9.35,scaleY:9.35,x:-930.3,y:-1839.6,startPosition:294},0).wait(1).to({scaleX:6.57,scaleY:6.57,x:-573.9,y:-1151.3,startPosition:295},0).wait(1).to({scaleX:3.78,scaleY:3.78,x:-217.5,y:-463,startPosition:296},0).wait(1).to({scaleX:1,scaleY:1,x:138.9,y:225.2,startPosition:297},0).wait(1).to({startPosition:298},0).wait(1).to({startPosition:299},0).wait(1).to({startPosition:300},0).wait(1).to({startPosition:301},0).wait(1).to({startPosition:302},0).wait(1).to({startPosition:303},0).wait(1).to({startPosition:304},0).wait(1).to({startPosition:305},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:3},0).to({_off:true},1).wait(590));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_2).wait(167).to({_off:false},0).to({_off:true},143).wait(590));

	// Scene2_Bottom
	this.instance_10 = new lib.Scene2_Bottom("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(267.4,84.7,1,1,0,0,0,247.4,-113.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(1).to({y:85.2,startPosition:1},0).wait(1).to({y:85.7,startPosition:2},0).wait(1).to({y:86.2,startPosition:3},0).wait(1).to({y:86.8,startPosition:4},0).wait(1).to({y:87.3,startPosition:5},0).wait(1).to({y:87.8,startPosition:6},0).wait(1).to({y:88.4,startPosition:7},0).wait(1).to({y:88.9,startPosition:8},0).wait(1).to({y:89.4,startPosition:9},0).wait(1).to({y:90,startPosition:10},0).wait(1).to({y:90.5,startPosition:11},0).wait(1).to({y:91,startPosition:12},0).wait(1).to({y:91.5,startPosition:13},0).wait(1).to({y:92.1,startPosition:14},0).wait(1).to({y:92.6,startPosition:15},0).wait(1).to({y:93.1,startPosition:16},0).wait(1).to({y:93.7,startPosition:17},0).wait(1).to({y:94.2,startPosition:18},0).wait(1).to({y:94.7,startPosition:19},0).wait(1).to({y:95.3,startPosition:20},0).wait(1).to({y:95.8,startPosition:21},0).wait(1).to({y:96.3,startPosition:22},0).wait(1).to({y:96.8,startPosition:23},0).wait(1).to({y:97.4,startPosition:24},0).wait(1).to({y:97.9,startPosition:25},0).wait(1).to({y:98.4,startPosition:26},0).wait(1).to({y:99,startPosition:27},0).wait(1).to({y:99.5,startPosition:28},0).wait(1).to({y:100,startPosition:29},0).wait(1).to({y:100.6,startPosition:30},0).wait(1).to({y:101.1,startPosition:31},0).wait(1).to({y:101.6,startPosition:32},0).wait(1).to({y:102.1,startPosition:33},0).wait(1).to({y:102.7,startPosition:34},0).wait(1).to({y:103.2,startPosition:35},0).wait(1).to({y:103.7,startPosition:36},0).wait(1).to({y:104.3,startPosition:37},0).wait(1).to({y:104.8,startPosition:38},0).wait(1).to({y:105.3,startPosition:39},0).wait(1).to({y:105.9,startPosition:40},0).wait(1).to({y:106.4,startPosition:41},0).wait(1).to({y:106.9,startPosition:42},0).wait(1).to({y:107.4,startPosition:43},0).wait(1).to({y:108,startPosition:44},0).wait(1).to({y:108.5,startPosition:45},0).wait(1).to({y:109,startPosition:46},0).wait(1).to({y:109.6,startPosition:47},0).wait(1).to({y:110.1,startPosition:48},0).wait(1).to({y:110.6,startPosition:49},0).wait(1).to({y:111.2,startPosition:50},0).wait(1).to({y:111.7,startPosition:51},0).wait(1).to({y:112.2,startPosition:52},0).wait(1).to({y:112.7,startPosition:53},0).wait(1).to({y:113.3,startPosition:54},0).wait(1).to({y:113.8,startPosition:55},0).wait(1).to({y:114.3,startPosition:56},0).wait(1).to({y:114.9,startPosition:57},0).wait(1).to({y:115.4,startPosition:58},0).wait(1).to({y:115.9,startPosition:59},0).wait(1).to({y:116.5,startPosition:60},0).wait(1).to({y:117,startPosition:61},0).wait(1).to({y:117.5,startPosition:62},0).wait(1).to({y:118,startPosition:63},0).wait(1).to({y:118.6,startPosition:64},0).wait(1).to({y:119.1,startPosition:65},0).wait(1).to({y:119.6,startPosition:66},0).wait(1).to({y:120.2,startPosition:67},0).wait(1).to({y:120.7,startPosition:68},0).wait(1).to({y:121.2,startPosition:69},0).wait(1).to({y:121.8,startPosition:70},0).wait(1).to({y:122.3,startPosition:71},0).wait(1).to({y:122.8,startPosition:72},0).wait(1).to({y:123.3,startPosition:73},0).wait(1).to({y:123.9,startPosition:74},0).wait(1).to({y:124.4,startPosition:75},0).wait(1).to({y:124.9,startPosition:76},0).wait(1).to({y:125.5,startPosition:77},0).wait(1).to({y:126,startPosition:78},0).wait(1).to({y:126.5,startPosition:79},0).wait(1).to({y:127.1,startPosition:80},0).wait(1).to({y:127.6,startPosition:81},0).wait(1).to({y:128.1,startPosition:82},0).wait(1).to({y:128.7,startPosition:83},0).wait(1).to({y:129.2,startPosition:84},0).wait(1).to({y:129.7,startPosition:85},0).wait(1).to({y:130.2,startPosition:86},0).wait(1).to({y:130.8,startPosition:87},0).wait(1).to({y:131.3,startPosition:88},0).wait(1).to({y:131.8,startPosition:89},0).wait(1).to({y:132.4,startPosition:90},0).wait(1).to({y:132.9,startPosition:91},0).wait(1).to({y:133.4,startPosition:92},0).wait(1).to({y:134,startPosition:93},0).wait(1).to({y:134.5,startPosition:94},0).wait(1).to({y:135,startPosition:95},0).wait(1).to({y:135.5,startPosition:96},0).wait(1).to({y:136.1,startPosition:97},0).wait(1).to({y:136.6,startPosition:98},0).wait(1).to({y:137.1,startPosition:99},0).wait(1).to({y:137.7,startPosition:100},0).wait(1).to({y:138.2,startPosition:101},0).wait(1).to({y:138.7,startPosition:102},0).wait(1).to({y:139.3,startPosition:103},0).wait(1).to({y:139.8,startPosition:104},0).wait(1).to({y:140.3,startPosition:105},0).wait(1).to({y:140.8,startPosition:106},0).wait(1).to({y:141.4,startPosition:107},0).wait(1).to({y:141.9,startPosition:108},0).wait(1).to({y:142.4,startPosition:109},0).wait(1).to({y:143,startPosition:110},0).wait(1).to({y:143.5,startPosition:111},0).wait(1).to({y:144,startPosition:112},0).wait(1).to({y:144.6,startPosition:113},0).wait(1).to({y:145.1,startPosition:114},0).wait(1).to({y:145.6,startPosition:115},0).wait(1).to({y:146.1,startPosition:116},0).wait(1).to({y:146.7,startPosition:117},0).wait(1).to({y:147.2,startPosition:118},0).wait(1).to({y:147.7,startPosition:119},0).wait(1).to({y:148.3,startPosition:120},0).wait(1).to({y:148.8,startPosition:121},0).wait(1).to({y:149.3,startPosition:122},0).wait(1).to({y:149.9,startPosition:123},0).wait(1).to({y:150.4,startPosition:124},0).wait(1).to({y:150.9,startPosition:125},0).wait(1).to({y:151.4,startPosition:126},0).wait(1).to({y:152,startPosition:127},0).wait(1).to({y:152.5,startPosition:128},0).wait(1).to({y:153,startPosition:129},0).wait(1).to({y:153.6,startPosition:130},0).wait(1).to({y:154.1,startPosition:131},0).wait(1).to({y:154.6,startPosition:132},0).wait(1).to({y:155.2,startPosition:133},0).wait(1).to({y:155.7,startPosition:134},0).wait(1).to({y:156.2,startPosition:135},0).wait(1).to({y:156.7,startPosition:136},0).wait(1).to({y:157.3,startPosition:137},0).wait(1).to({y:157.8,startPosition:138},0).wait(1).to({y:158.3,startPosition:139},0).wait(1).to({y:158.9,startPosition:140},0).wait(1).to({y:159.4,startPosition:141},0).wait(1).to({y:159.9,startPosition:142},0).wait(1).to({y:160.5,startPosition:143},0).wait(1).to({y:161,startPosition:144},0).wait(1).to({y:161.5,startPosition:145},0).wait(1).to({y:162,startPosition:146},0).wait(1).to({y:162.6,startPosition:147},0).wait(1).to({y:163.1,startPosition:148},0).wait(1).to({y:163.6,startPosition:149},0).wait(1).to({y:164.2,startPosition:150},0).wait(1).to({y:164.7,startPosition:151},0).wait(1).to({y:165.2,startPosition:152},0).wait(1).to({y:165.8,startPosition:153},0).wait(1).to({y:166.3,startPosition:154},0).wait(1).to({y:166.8,startPosition:155},0).wait(1).to({y:167.3,startPosition:156},0).wait(1).to({y:167.9,startPosition:157},0).wait(1).to({y:168.4,startPosition:158},0).wait(1).to({y:168.9,startPosition:159},0).wait(1).to({y:169.5,startPosition:160},0).wait(1).to({y:170,startPosition:161},0).wait(1).to({y:170.5,startPosition:162},0).wait(1).to({y:171.1,startPosition:163},0).wait(1).to({y:171.6,startPosition:164},0).wait(1).to({y:172.1,startPosition:165},0).wait(1).to({y:172.7,startPosition:166},0).wait(1).to({startPosition:167},0).wait(1).to({startPosition:168},0).wait(1).to({startPosition:169},0).wait(1).to({startPosition:170},0).wait(1).to({startPosition:171},0).wait(1).to({startPosition:172},0).wait(1).to({startPosition:173},0).wait(1).to({startPosition:174},0).wait(1).to({startPosition:175},0).wait(1).to({startPosition:176},0).wait(1).to({startPosition:177},0).wait(1).to({startPosition:178},0).wait(1).to({startPosition:179},0).wait(1).to({startPosition:180},0).wait(1).to({startPosition:181},0).wait(1).to({startPosition:182},0).wait(1).to({startPosition:183},0).wait(1).to({startPosition:184},0).wait(1).to({startPosition:185},0).wait(1).to({startPosition:186},0).wait(1).to({startPosition:187},0).wait(1).to({startPosition:188},0).wait(1).to({startPosition:189},0).wait(1).to({startPosition:190},0).wait(1).to({startPosition:191},0).wait(1).to({startPosition:192},0).wait(1).to({startPosition:193},0).wait(1).to({startPosition:194},0).wait(1).to({startPosition:195},0).wait(1).to({startPosition:196},0).wait(1).to({startPosition:197},0).wait(1).to({startPosition:198},0).wait(1).to({startPosition:199},0).wait(1).to({startPosition:200},0).wait(1).to({startPosition:201},0).wait(1).to({startPosition:202},0).wait(1).to({startPosition:203},0).wait(1).to({scaleX:3.78,scaleY:3.78,y:-661.5,startPosition:204},0).wait(1).to({scaleX:6.57,scaleY:6.57,y:-1495.7,startPosition:205},0).wait(1).to({scaleX:9.35,scaleY:9.35,y:-2329.9,startPosition:206},0).wait(1).to({scaleX:12.13,scaleY:12.13,y:-3164.1,startPosition:207},0).wait(1).to({startPosition:208},0).wait(1).to({startPosition:209},0).wait(1).to({startPosition:210},0).wait(1).to({startPosition:211},0).wait(1).to({startPosition:212},0).wait(1).to({startPosition:213},0).wait(1).to({startPosition:214},0).wait(1).to({startPosition:215},0).wait(1).to({startPosition:216},0).wait(1).to({startPosition:217},0).wait(1).to({startPosition:218},0).wait(1).to({startPosition:219},0).wait(1).to({startPosition:220},0).wait(1).to({startPosition:221},0).wait(1).to({startPosition:222},0).wait(1).to({startPosition:223},0).wait(1).to({startPosition:224},0).wait(1).to({startPosition:225},0).wait(1).to({startPosition:226},0).wait(1).to({startPosition:227},0).wait(1).to({startPosition:228},0).wait(1).to({startPosition:229},0).wait(1).to({startPosition:230},0).wait(1).to({startPosition:231},0).wait(1).to({startPosition:232},0).wait(1).to({startPosition:233},0).wait(1).to({startPosition:234},0).wait(1).to({startPosition:235},0).wait(1).to({startPosition:236},0).wait(1).to({startPosition:237},0).wait(1).to({startPosition:238},0).wait(1).to({startPosition:239},0).wait(1).to({startPosition:240},0).wait(1).to({startPosition:241},0).wait(1).to({startPosition:242},0).wait(1).to({startPosition:243},0).wait(1).to({startPosition:244},0).wait(1).to({startPosition:245},0).wait(1).to({startPosition:246},0).wait(1).to({startPosition:247},0).wait(1).to({startPosition:248},0).wait(1).to({startPosition:249},0).wait(1).to({startPosition:250},0).wait(1).to({startPosition:251},0).wait(1).to({startPosition:252},0).wait(1).to({startPosition:253},0).wait(1).to({startPosition:254},0).wait(1).to({startPosition:255},0).wait(1).to({startPosition:256},0).wait(1).to({startPosition:257},0).wait(1).to({startPosition:258},0).wait(1).to({startPosition:259},0).wait(1).to({startPosition:260},0).wait(1).to({startPosition:261},0).wait(1).to({startPosition:262},0).wait(1).to({startPosition:263},0).wait(1).to({startPosition:264},0).wait(1).to({startPosition:265},0).wait(1).to({startPosition:266},0).wait(1).to({startPosition:267},0).wait(1).to({startPosition:268},0).wait(1).to({startPosition:269},0).wait(1).to({startPosition:270},0).wait(1).to({startPosition:271},0).wait(1).to({startPosition:272},0).wait(1).to({startPosition:273},0).wait(1).to({startPosition:274},0).wait(1).to({startPosition:275},0).wait(1).to({startPosition:276},0).wait(1).to({startPosition:277},0).wait(1).to({startPosition:278},0).wait(1).to({startPosition:279},0).wait(1).to({startPosition:280},0).wait(1).to({startPosition:281},0).wait(1).to({startPosition:282},0).wait(1).to({startPosition:283},0).wait(1).to({startPosition:284},0).wait(1).to({startPosition:285},0).wait(1).to({startPosition:286},0).wait(1).to({startPosition:287},0).wait(1).to({startPosition:288},0).wait(1).to({startPosition:289},0).wait(1).to({startPosition:290},0).wait(1).to({startPosition:291},0).wait(1).to({startPosition:292},0).wait(1).to({startPosition:293},0).wait(1).to({scaleX:9.35,scaleY:9.35,y:-2329.9,startPosition:294},0).wait(1).to({scaleX:6.57,scaleY:6.57,y:-1495.7,startPosition:295},0).wait(1).to({scaleX:3.78,scaleY:3.78,y:-661.5,startPosition:296},0).wait(1).to({scaleX:1,scaleY:1,y:172.7,startPosition:297},0).wait(1).to({startPosition:298},0).wait(1).to({startPosition:299},0).wait(1).to({startPosition:300},0).wait(1).to({startPosition:301},0).wait(1).to({startPosition:302},0).wait(1).to({startPosition:303},0).wait(1).to({startPosition:304},0).wait(1).to({startPosition:305},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:1},0).wait(1).to({startPosition:2},0).wait(1).to({startPosition:3},0).to({_off:true},1).wait(590));
	...
	this.timeline.addTween(cjs.Tween.get(this.Text2_Container).wait(1).to({regX:103.7,regY:274.1,x:123.7,y:348.6},0).wait(65).to({regX:150,regY:72.5,x:170,y:147},0).wait(1).to({regX:103.7,regY:274.1,x:123.7,y:348.6,alpha:0.25},0).wait(1).to({alpha:0.5},0).wait(1).to({alpha:0.75},0).wait(1).to({alpha:1},0).wait(1).to({regX:150,regY:72.5,x:170,y:147},0).wait(76).to({regX:103.7,regY:274.1,x:123.7,y:348.6,alpha:0.5},0).wait(1).to({alpha:0},0).to({_off:true},1).wait(751));
	...
	this.TextStart_Container.setTransform(198.5,238,1,1,0,0,0,150,29);
	this.TextStart_Container.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.TextStart_Container).wait(1).to({regX:101.5,regY:-42.2,x:150,y:160.3,alpha:0.083},0).wait(1).to({y:157.6,alpha:0.167},0).wait(1).to({y:155.8,alpha:0.25},0).wait(1).to({y:154.4,alpha:0.333},0).wait(1).to({y:153.4,alpha:0.417},0).wait(1).to({y:152.6,alpha:0.5},0).wait(1).to({y:152,alpha:0.583},0).wait(1).to({y:151.5,alpha:0.667},0).wait(1).to({y:151.2,alpha:0.75},0).wait(1).to({y:151,alpha:0.833},0).wait(1).to({y:150.8,alpha:0.917},0).wait(1).to({alpha:1},0).wait(1).to({regX:150,regY:29,x:198.5,y:222},0).to({_off:true},58).wait(829));

	// BG_grad
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["rgba(0,96,112,0)","#006070"],[0,1],-0.1,-240,-0.1,239.9).s().p("EgY/AlgMAAAhK/MAx/AAAMAAABK/g");
	this.shape_3.setTransform(150,300,0.937,1.25);
...
p.nominalBounds = new cjs.Rectangle(59.7,300,913.3,913.1);
// library properties:
lib.properties = {
	width: 300,
	height: 600,
